...
import com.weeds.openapi.common.model.dto.post.PostAddRequest;
import com.weeds.openapi.common.model.dto.post.PostEditRequest;
import com.weeds.openapi.common.model.dto.post.PostQueryRequest;
import com.weeds.openapi.common.model.dto.post.PostUpdateRequest;
import com.weeds.openapi.common.model.entity.Post;
import com.weeds.openapi.common.model.entity.User;
import com.weeds.openapi.common.model.vo.PostVO;
import com.weeds.openapi.service.PostService;
...
public class PostController {
    ...
    public BaseResponse<Long> addPost(@RequestBody PostAddRequest postAddRequest, HttpServletRequest request) {
        Optional.ofNullable(postAddRequest).orElseThrow(() -> new BusinessException(ErrorCode.PARAMS_ERROR));
        Post post = new Post();
    ...
    public BaseResponse<Page<PostVO>> listMyPostVOByPage(
            @RequestBody PostQueryRequest postQueryRequest,
            HttpServletRequest request) {
        Optional.ofNullable(postQueryRequest).orElseThrow(() -> new BusinessException(ErrorCode.PARAMS_ERROR));
        User loginUser = userService.getLoginUser(request);
