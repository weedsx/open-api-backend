...
import com.weeds.openapi.common.model.dto.user.UserQueryRequest;
import com.weeds.openapi.common.model.entity.User;
import com.weeds.openapi.common.model.enums.UserRoleEnum;
import com.weeds.openapi.common.model.vo.LoginUserVO;
import com.weeds.openapi.common.model.vo.UserVO;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    private final int USER_ACCOUNT_MAX_LENGTH = 4;
    private final int USER_PASSWORD_MAX_LENGTH = 8;
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        ThrowUtils.throwIf(userAccount.length() < USER_ACCOUNT_MAX_LENGTH,
                ErrorCode.PARAMS_ERROR, "用户账号过短");
        ThrowUtils.throwIf(userPassword.length() < USER_PASSWORD_MAX_LENGTH ||
                        checkPassword.length() < USER_PASSWORD_MAX_LENGTH,
        ...
        synchronized (userAccount.intern()) {
            ...
            String accessKey = DigestUtil.sha256Hex(SALT + userAccount + RandomUtil.randomString(5));
            String secretKey = DigestUtil.sha256Hex(SALT + userPassword + RandomUtil.randomString(8));
            // 4. 插入数据
            User user = new User();
